...
const Footer = () => {
  return (
    <div className="w-full bg-slate-100 min-h-[30vh] py-5 px-20 mt-5 grid grid-cols-9 gap-10">
      <div className="col-span-3">
        <h3 className="text-lg">Công Ty Cổ Phần Dairy</h3>
        <p className="text-lg">Thành viên của Tập đoàn Dairy Group</p>
        <p>Email: cskh@dairy.com</p>
        <p>Điện thoại: 0987 654 321</p>
